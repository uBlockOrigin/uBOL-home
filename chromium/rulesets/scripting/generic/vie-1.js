...
const exceptions = /* 21 */[".qc",".qc","#adsContainer","[id^=\"adm-slot\"]",".showads","#ad-wrapper",".qc","#ad-wrapper","[class^=\"div-gpt-ad\"]",".advertiser",".c-ads",".imageads","#ad-slot",".qc",".adheader",".banner-bottom","ins.adsbygoogle[data-ad-slot]",".ads_top","#horizontal-ad\n.blogAd",".ad-space\n.ad_unit",".inline-ad"];
const hostnames = /* 21 */["dm.de","msn.com","pops.vn","cafef.vn","vndoc.com","cap3.email","medium.com","qmh.garden","quykhu.com","www.vn2c.my","sayhentai.cx","thanhnien.vn","timvanban.vn","livescore.com","tratu.soha.vn","vnexpress.net","ios.codevn.net","nhipcaudautu.vn","phongroblox.com","googleapiscdn.com","gicovietnam.blogspot.com"];
