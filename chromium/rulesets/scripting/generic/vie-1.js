...
const exceptions = /* 20 */[".qc",".advertiser",".qc","#adsContainer","[id^=\"adm-slot\"]",".showads",".qc","[class^=\"div-gpt-ad\"]","ins.adsbygoogle[data-ad-slot]",".c-ads",".imageads","#ad-slot",".qc",".adheader",".banner-bottom","ins.adsbygoogle[data-ad-slot]",".ads_top","#horizontal-ad\n.blogAd",".ad-space\n.ad_unit",".inline-ad"];
const hostnames = /* 20 */["dm.de","vn2.vn","msn.com","pops.vn","cafef.vn","vndoc.com","medium.com","quykhu.com","ipacrack.com","sayhentai.sh","thanhnien.vn","timvanban.vn","livescore.com","tratu.soha.vn","vnexpress.net","ios.codevn.net","nhipcaudautu.vn","phongroblox.com","googleapiscdn.com","gicovietnam.blogspot.com"];
