...
const $scriptletArgs$ = /* 41 */ ["_ga","OK","","reload","1","views","script","/^ipc\\.loader\\.queue\\.jquery(\\.push\\(function\\(\\)\\{\\s*ipc\\.loader\\.script\\(.+\\/ipc\\.watch\\.js.+)/","ipc.loader.queue.ready$1","#gn-rwd-target-hidden","class","rewareded","gnrwdfreq","adblock","banners-brand","#page_content","in_m4","roadblocker","pageCount","$remove$","playcnt","no_postitial_content","fixed_ad","#header.fixed_ad","hasStickyHead","body.hasStickyHead","pt-[100px]","#main-container","no_postitial_video","mobile-sticky-ad-is-active","body","inter","branding","body[id=\"pagebody\"]","i4It-cmp2-toaster-visible",".i4It","pwa_show","true","pShowMob","has-adhesion",".header-placeholder.has-adhesion"];
