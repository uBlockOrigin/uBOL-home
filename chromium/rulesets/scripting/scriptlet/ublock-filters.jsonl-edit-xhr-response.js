...
const argsList = [[".data[?@.category==\"SPONSORED\"].node","propsToMatch","/graphql"],[".data.node[?.*.__typename==\"SponsoredData\"]","propsToMatch","/graphql"],[".data.viewer.news_feed.edges.*[?@.category==\"SPONSORED\"].node","propsToMatch","/graphql"],[".data.viewer.marketplace_feed_stories.edges.*[?@.node.__typename==\"MarketplaceFeedAdStory\"]","/graphql"]];
