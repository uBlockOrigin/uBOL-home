...
const hostnamesMap = new Map([["avtorambler.*",0],["championat.*",0],["eda.*",0],["gazeta.press",0],["gazeta.ru",0],["lenta.*",0],["letidor.*",0],["moslenta.*",0],["motor.*",0],["passion.*",0],["quto.*",0],["rambler.*",0],["wmj.*",0],["www.afisha.*",0],["dzen.*",1],["ya.*",1],["yandex.*",1],["mail.yandex.*",2]]);
