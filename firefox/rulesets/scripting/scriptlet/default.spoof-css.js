...
const argsList = [["#MainContainer > [id]:has(> [id^=\"btIn\"] > #bannerTop)","clip-path","none"],["#btx1, #btx2, #wg-genx > .mediafire","visibility","visible"],["a img:not([src=\"images/main_logo_inverted.png\"])","visibility","visible"]];
