...
const argsList = [["iframe.a","position","static","visibility","visible"],["#topbox","display","block","height","286px","visibility","visible"],["#afterbox","display","block","height","255px","visibility","visible"],["ins.adsbygoogle iframe","display","block","height","284px"],["[class^=\"caca-\"], .sssh, .ssh, .sh, .show, h1[class$=\"text-center fs28\"] + p + p[class], ins.adsbygoogle, #beforebox","visibility","visible"],["div[id^=\"showtheadsfatf_\"], div[id^=\"imgyad\"], .showtheadsfatf, a[href=\"https://searchenginereports.net/gmadads\"]","display","block"],["[id$=\"ink_1000x100_anchor_top\"], [id$=\"ink_1000x100_anchor\"]","z-index","2147483647"]];

const hostnamesMap = new Map([["ylilauta.org",0],["plagiarismchecker.co",[1,2,3,4]],["searchenginereports.net",5],["dragontea.ink",6]]);
